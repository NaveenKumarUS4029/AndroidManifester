...
import ran.am.androidmanifester.notesroom.MainActivity2DB;
import ran.am.androidmanifester.s3_v2_viewmodeldemo.Content;
import ran.am.androidmanifester.s3_v2_viewmodeldemo.MainActivity4;
...
//            Toast.makeText(AndroidManifesterCodes.this, "You have selected " + modelArrayList2, Toast.LENGTH_SHORT).show();
                ...
                switch (sel) {
                    ...
                    case "Simple ROOM Database Example":
                        startActivity(new Intent(AndroidManifesterCodes.this, MainActivity2DB.class));
                        //Toast.makeText(MainActivity.this, "", Toast.LENGTH_LONG).show();
                        break;

                    case "Livedata Example":
                        startActivity(new Intent(AndroidManifesterCodes.this, MainActivity4.class));
                        //Toast.makeText(MainActivity.this, "", Toast.LENGTH_LONG).show();
                        break;

                    case "MVVM Example":
                        startActivity(new Intent(AndroidManifesterCodes.this, Content.class));
        ...
        for (int i = 0; i < title2.length;i++){
            AndroidManifesterModel androidManifesterModel = new AndroidManifesterModel(title2[i],image2[i]);
